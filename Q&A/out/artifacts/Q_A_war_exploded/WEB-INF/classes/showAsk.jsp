...
<div class="mainbox">
    ...
    <div class="mainleft" style="width: 50%">


        <div class="leftinfo">
            <div class="listtitle"><c:if test="${requestScope.status!='0'}"><a href="ms?oper=showAns&mid=${requestScope.mid}&type=show" class="more1">查看回复</a></c:if>课程：${requestScope.cname}</div>
